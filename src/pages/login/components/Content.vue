    ...
    <div class="content__user">
      ...
      <div class="content__user_form">
        <span
          ...
          class="content__user_form_errorTips"
        >用户名或密码错误</span>
        <el-input
          placeholder="请输入用户名"
          v-model="username"
          clearable
          class="content__user_form__username"
        >
        </el-input>
        <el-input
          placeholder="请输入密码"
          ...
          type="password"
          clearable
          class="content__user_form__password"
        >
        </el-input>
        <div class="content__usere_form__ccode">
          <el-input
            ...
            v-model="vcode"
            clearable
            class="content__user_form__ccode_ipt"
          >
          </el-input>
          <span
            class="content__user_form__ccode_text"
            @click="generatedCode"
          >
            {{this.ccode}}
          </span>
        ...
        <el-button
          class="content__user_form__btn-login"
          plain
          @click="checkCode"
        >登陆</el-button>
        <div class="content__user_form__ext">
          <el-button
            type="text"
            class="content__user_form__ext__register"
            @click="userRegister"
          >注册</el-button>
