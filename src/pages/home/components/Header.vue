<template>
    <div class="header">
        <div class="header__left">
            <img src="../../../assets/images/home/logo.png" alt="" class="header__left_img">
            <p class="header__left_title">共享插座后台管理系统</p>
        </div>
        <div class="header__right">
            <div class="header__right__user-title">
                <img class="header__right__user-title__img" src="../../../assets/images/login/lh_img.jpg" alt="">
